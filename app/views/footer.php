...
<div class="container-fluid" id="footer">
    <div class="row justify-content-evenly ptb20">
        <div class="col">
            <h6 class="text-center">About us</h6>
            <p>thefestivel1.nl is dedicates to present Haarlem's offering in an engaging way</p>
        ...
        <div class="col">
            ...
            <p class="text-center">Group 1</p>
            <p class="text-center">IT2B Inholland Haarlem</p>
        </div>
    </div>
</div>
</body> 
