<div class="form-group row mb-1">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="name" name="name"
               value="<?= isset($restaurantToEdit) ? $restaurantToEdit->getName() : '' ?>" required>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="location" name="location"
               value="<?= isset($restaurantToEdit) ? $restaurantToEdit->getLocation() : '' ?>" required>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="cuisine" name="cuisine"
               value="<?= isset($restaurantToEdit) ? $restaurantToEdit->getCuisine() : '' ?>" required>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-sm-10">
        <input type="number" class="form-control" id="seats" name="seats"
               value="<?= isset($restaurantToEdit) ? $restaurantToEdit->getSeats() : '' ?>" required>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-sm-10">
        <input type="number" class="form-control" id="stars" name="stars"
               value="<?= isset($restaurantToEdit) ? $restaurantToEdit->getStars() : '' ?>" required>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-sm-10">
        <input type="email" class="form-control" id="email" name="email"
               value="<?= isset($restaurantToEdit) ? $restaurantToEdit->getEmail() : '' ?>" required>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="phonenumber" name="phonenumber"
               value="<?= isset($restaurantToEdit) ? $restaurantToEdit->getPhonenumber() : '' ?>" required>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-sm-10">
        <input type="number" step="any" class="form-control" id="price" name="price"
               value="<?= isset($restaurantToEdit) ? $restaurantToEdit->getPrice() : 0 ?>" required>
    </div>
</div>
