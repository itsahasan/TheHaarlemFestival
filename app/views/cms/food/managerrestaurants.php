...
<div class="px-4">
    ...
    <table class="table table-striped table-responsive">
        <thead>
        <tr>
            <th>ID</th><th>Name</th><th>Location</th><th>Cuisine</th><th>Seats</th><th>Stars</th><th>Email</th><th>Phone</th><th>Price</th>
        ...
        <?php foreach ($restaurants as $restaurant): ?>
            <tr>
                ...
                <td><img src="data:image/jpeg;base64,<?= base64_encode($restaurant->getImage1()) ?>" height="100"></td>
                <td><img src="data:image/jpeg;base64,<?= base64_encode($restaurant->getImage2()) ?>" height="100"></td>
                <td><img src="data:image/jpeg;base64,<?= base64_encode($restaurant->getImage3()) ?>" height="100"></td>
                <td>
                    <form method="POST">
                ...
                <td>
                    <form method="POST" action="/yummy/deleterestaurant?restaurantid=<?= $restaurant->getId() ?>">
